...
angular.module("mean.articles").service("ForgetPassword", ["$resource", function ($resource) {
    return $resource("forgetpassword/:email", {
        email: "@email"
    });
}]);

angular.module("mean.articles").service("ResetPassword", ["$resource", function ($resource) {
